...
those modules. `tests/test_startup_imports.py` holds the second, on the
interpreters CI runs; nothing holds the timing. This module plays no part in it
— importing `base`, or the package, is exactly as cheap.
