...
python tests/record_child_network.py  # what the processes the suite starts dial; the
                                    #   whole suite in an archived commit, 0/1/2
...
npm test                            #   is committed. 138 tests (8 `it.fails`), jsdom, no network
